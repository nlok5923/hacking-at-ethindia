...
export interface SimpleAccountForTokensInterface extends utils.Interface {
  functions: {
...
export interface SimpleAccountForTokens extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: SimpleAccountForTokensInterface;
